...
print(f"\tmomentum\tenergy")
for momentum, energy in zip(momenta, energies):
    print(f"\t{momentum:.3f}\t\t{energy:.4f}")
...
).to_csv("momentum-vs-energy.csv", index=False, float_format="%.5f")
